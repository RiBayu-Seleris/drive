  ...
  return (
    ...
    >
      <p className="text-12 mb-3 text-neutral-600">
        ...
        kamera ke barcode-nya. Minta ia menekan tombol kodenya sekali lagi untuk memperbesar. Bisa juga diketik manual — nomor klaim dan kode kunjungan (WVS) ikut diterima.
      </p>
